...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        BarGreaterThanToken = 39,
        BarGreaterThanGreaterThanToken = 40,
        PlusToken = 41,
        MinusToken = 42,
        AsteriskToken = 43,
        ...
        CallExpression = 207,
        PipelineHackExpression = 208,
        PipelineApplicationExpression = 209,
        NewExpression = 210,
        ...
        FirstAssignment = 65,
        LastAssignment = 80,
        FirstCompoundAssignment = 66,
        LastCompoundAssignment = 80,
    ...
    export type PipelineOperatorOrHigher = LogicalOperatorOrHigher | SyntaxKind.BarGreaterThanToken | SyntaxKind.BarGreaterThanGreaterThanToken;
    ...
    export type CallLikeExpression = CallExpression | NewExpression | TaggedTemplateExpression | Decorator | PipelineApplicationExpression | JsxOpeningLikeElement;
...
declare namespace ts {
    ...
    function isPipelineHackExpression(node: Node): node is PipelineHackExpression;
    function isPipelineApplicationExpression(node: Node): node is PipelineApplicationExpression;
